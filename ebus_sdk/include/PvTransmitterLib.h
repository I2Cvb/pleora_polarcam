...
#define __PVTRANSMITTERLIB_H__
    ...
    #pragma comment( lib, "PvTransmitter" PT_SUFFIX_64 PT_SUFFIX_HYPHEN PT_SUFFIX_STATIC PT_SUFFIX_DEBUG ".lib" )
...
#endif // PV_TRANSMITTER_EXPORTS

#endif // __PVTRANSMITTERLIB_H__
